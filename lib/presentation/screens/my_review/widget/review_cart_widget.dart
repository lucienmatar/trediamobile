...
class ReviewCartWidget extends StatelessWidget {
  ...
  const ReviewCartWidget({super.key, required this.controller, required this.productModel});
      ...
      children: [
        Row(
          children: [
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Row(
                        children: [Text("${MyStrings.soldBy} ", style: regularDefaultInter.copyWith(color: MyColor.contentTextColor)), Text(MyStrings.mazumderIt.tr, style: regularDefaultInter.copyWith(color: MyColor.primaryColor))],
                      )
                    ],
                  ),
                ],
            ...
            InkWell(
              onTap: () {
                CustomBottomSheet(child: GetBuilder<MyReviewController>(builder: (controller) => SubmitReviewBottomSheet(controller: controller))).customBottomSheet(context);
              },
              child: Container(
                padding: const EdgeInsets.symmetric(horizontal: Dimensions.space6, vertical: Dimensions.space6),
                decoration: BoxDecoration(color: MyColor.iconsBackground, borderRadius: BorderRadius.circular(3)),
                child: Row(
                  children: [
                    const Icon(
                      Icons.star,
                      size: Dimensions.space11,
                      color: MyColor.primaryColor,
                    ),
                    Text(
                      " ${MyStrings.review}",
                      style: regularDefaultInter.copyWith(color: MyColor.primaryColor, fontSize: Dimensions.space12, fontWeight: FontWeight.w500),
                    )
                  ],
                ),
              ),
