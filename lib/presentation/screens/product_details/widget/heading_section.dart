...
class HeadingSection extends StatelessWidget {
  ...
  const HeadingSection({super.key, required this.controller});
      ...
      children: [
        ...
        Row(
          children: [
            ...
            Text("${MyStrings.inStock}(${controller.totalStock})", style: mediumDefault.copyWith(color: MyColor.stockTextColor)),
