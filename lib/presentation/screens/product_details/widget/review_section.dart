      ...
      children: [
        Column(
          children: List.generate(
              controller.reviewPercentage.length,
              (index) => Column(
                    children: [
                      Row(
                        children: [
                          ...
                          Expanded(
                            child: Container(
                              ...
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [Container(height: Dimensions.space5, width: (size.width * .5) * controller.reviewPercentage[index] / 100, decoration: BoxDecoration(color: MyColor.colorOrange, borderRadius: BorderRadius.circular(Dimensions.space10)))],
                              ),
                            ),
                          ),
                          const SizedBox(
                          ...
                          Text(
                            "${controller.reviewPercentage[index]}%",
                            style: semiBoldLargeInter.copyWith(fontWeight: FontWeight.w400),
                          )
                        ],
                      ),
                      const SizedBox(
        ...
        Row(
          children: [
            ...
            const Spacer(),
            BodyText(text: MyStrings.dateText),
          ],
        ),
        const SizedBox(
